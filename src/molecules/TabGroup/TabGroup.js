...
const TabGroup = ({ changeHandler, selectedOption }) => {
  return (
    <div className='flex'>
      <Tab
        withIcon
      ...
      >
        <div className='flex'>
          ...
          <span className='hidden md:block'>Image Poll</span>
        </div>
      </Tab>
      <Tab
        withIcon
      ...
      >
        <div className='flex'>
          ...
          <span className='hidden md:block'>Text Poll</span>
        </div>
      </Tab>
      <Tab
        withIcon
      ...
      >
        <div className='flex'>
          ...
          <span className='hidden md:block'>Mini Survey</span>
        </div>
      </Tab>
    </div>
  );
